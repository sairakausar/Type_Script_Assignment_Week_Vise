...
var temperature_Celsiud = 41;
var result = temperature_Celsiud * 9 / 5 + 32;
console.log("Cto F", result);
var temperature_Fahrenheit = 41;
var result2 = (temperature_Fahrenheit - 32) * 5 / 9;
console.log("f2c", result2);
//  - Write a program that calculates the percentage.
var achive_number = 50;
var total_number = 90;
var percentage = (achive_number / total_number) * 100;
console.log("===percentage===");
console.log("The ".concat(total_number, " percentage of  ").concat(achive_number, "  is =  ").concat(percentage));
...
var given_number = 17;
var weeks = Math.floor(given_number / 7);
console.log("week", weeks);
var days = given_number % 7;
console.log("days", days);
console.log("In your given days ".concat(given_number, ", the total weeks are ").concat(weeks, " and ").concat(days, " days"));
...
var any_number = 101;
var divider_1 = 3;
var result_1 = any_number % divider_1;
var divider_2 = 5;
var result_2 = any_number % divider_2;
if (result_1 == 0) {
